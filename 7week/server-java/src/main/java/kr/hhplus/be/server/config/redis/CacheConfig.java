...
public class CacheConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        // 상품 랭킹 캐시: 1시간 유효
        cacheConfigurations.put("productRanks", redisCacheConfiguration().entryTtl(Duration.ofHours(1)));
        
        // 상위 상품 캐시: 10분 유효 (자주 업데이트되어야 함)
        cacheConfigurations.put("topProducts", redisCacheConfiguration().entryTtl(Duration.ofMinutes(10)));
